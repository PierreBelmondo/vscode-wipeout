...
export class GLTFExporter {
  pluginCallbacks: GLTFPluginCallback[];
  ...
  register(callback: GLTFPluginCallback) {
  ...
  unregister(callback: GLTFPluginCallback) {
    if (this.pluginCallbacks.indexOf(callback) !== -1) {
...
class GLTFWriter {
  ...
  processBufferView(
    ...
    if (componentType === WEBGL_CONSTANTS.BYTE) {
      componentSize = 1;
...
/**
 * GLTF plugin abstract class
 */
abstract class GLTFPlugin {
  writer: GLTFWriter;
  name: string;

  constructor(writer: GLTFWriter, name: string) {
    this.writer = writer;
    this.name = name;
  }
}
 ...
 */
export class GLTFLightExtension extends GLTFPlugin {
  constructor(writer: GLTFWriter) {
    super(writer, "KHR_lights_punctual");
  }
...
class GLTFMaterialsUnlitExtension extends GLTFPlugin {
  constructor(writer: GLTFWriter) {
    super(writer, "KHR_materials_unlit");
  }
 ...
 */
class GLTFMaterialsPBRSpecularGlossiness extends GLTFPlugin {
  constructor(writer: GLTFWriter) {
    super(writer, "KHR_materials_pbrSpecularGlossiness");
  }
 ...
 */
class GLTFMaterialsClearcoatExtension extends GLTFPlugin {
  constructor(writer: GLTFWriter) {
    super(writer, "KHR_materials_clearcoat");
  }
 ...
 */
class GLTFMaterialsIridescenceExtension extends GLTFPlugin {
  constructor(writer: GLTFWriter) {
    super(writer, "KHR_materials_iridescence");
  }
 ...
 */
class GLTFMaterialsTransmissionExtension extends GLTFPlugin {
  constructor(writer: GLTFWriter) {
    super(writer, "KHR_materials_transmission");
  }
 ...
 */
class GLTFMaterialsVolumeExtension extends GLTFPlugin {
  constructor(writer: GLTFWriter) {
    super(writer, "KHR_materials_volume");
  }
